				...
				<div class="container-fluid">
					...
					<div>
						<ul class="nav navbar-nav">
							<li class="active"><a href="admin_first.jsp">新建投票</a>
							</li>
							<li><a href="administrator_second.jsp">投票管理</a>
							</li>
				...
				<div class="col-md-12 column">
					<form class="form-horizontal" role="form"
						...
						<div class="form-group">
							...
							<div align="left">
								<select class="form-control" name="option-number"
									style="width:75px">
						...
						<div class="form-group">
							...
							<div>
								<select class="form-control" name="birthday-smell"
									style="width:100px">
						...
						<div class="form-group">
							...
							<div class="radio">
							 <label > <input type="radio"
								name="anonymity" value="公开" checked="true"> 公开 </label> <label
								> <input type="radio"
								name="anonymity" value="匿名"> 匿名 </label> </div>
						</div>

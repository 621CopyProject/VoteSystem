	...
	<div class="container">
		<div class="row clearfix">
			<div class="col-md-12 column">
				...
				<div class="container-fluid">
					...
					<div>
						<ul class="nav navbar-nav">
							<li class="active"><a href="admin_first.jsp">新建投票</a></li>
				...
				<%
					...
					try {
						...
						String sql = "insert into theme(themename,optionnumber,optionmode,anoymity,createname) values(?,?,?,?,?)";
			...
			<%
				...
				%>
			<form role="form" action="admin_first_action.jsp?themeid=<%= themeid%>&optionnumber=<%= option_number%>"
					method="post">
			<%
			...
			for(int i=1;i<=m;i++){
				...
				<div class="form-group">
						<input type="text"
							class="form-control" name="option<%= i%>" placeholder="选项<%= i%>">
					</div>
				<%
			}
			 %>
			 <div class="text-right">
			 			<a href="admin_first_d_action.jsp?themeid=<%= themeid%>" class="btn btn-danger">
			 			取消创建
			 			</a>

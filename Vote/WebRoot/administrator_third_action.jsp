...
<html>
  <head>
    ...
    <title>My JSP 'administrator_third_action.jsp' starting page</title>
  ...
  <body>
    <%
		...
		try{
			...
			String sql="update tip set state=? where themeid=?";
			pre = con.prepareStatement(sql);
				pre.setInt(1, 1);
				pre.setInt(2, Integer.parseInt(themeid));
				pre.executeUpdate();
				sql = "select * from theme where themeid=?";
			pre = con.prepareStatement(sql);
	...
	<div class="container">
		<div class="row clearfix">
			<div class="col-md-12 column">
				...
				<div align="center">
					<a href="administrator_third.jsp" class="btn btn-default"> 返回
					</a> <a href="administrator_third_d.jsp?themeid=<%= themeid%>"
